            ...
            <div class="row">
                ...
                <div class="col-12 col-md-4">
                    <div class="single-post-area mb-80">
                        ...
                        <div class="post-thumbnail" >
                            <img src="img/email.png" alt="" style="display: block; margin-left: auto; margin-right: auto; width=50%;">
                        ...
                        <div class="post-content">
                            ...
                            <a href="login.jsp?value=Reader" class="post-title" style="text-align: center">Through Email</a>
                ...
                <div class="col-12 col-md-4">
                    <div class="single-post-area mb-80">
                        <!-- Post Thumbnail -->
                        <div class="post-thumbnail">
                            <img src="img/or.png" alt=""  style="display: block; margin-left: auto; margin-right: auto; width=50%;" align="bottom" >
                ...
                <div class="col-12 col-md-4">
                    <div class="single-post-area mb-80">
                        <!-- Post Thumbnail -->
                        <div class="post-thumbnail">
                            <img src="img/securityq.png" alt=""  style="display: block; margin-left: auto; margin-right: auto; width=50%;">
                        ...
                        <div class="post-content">
                            ...
                            <a href="securityq.jsp" class="post-title" style="text-align: center">Through security Questions</a>
                            
                        </div>
                        <div class="post-content">
                            
                            <a href="single-post.html" class="post-title" style="text-align: center">        </a>
