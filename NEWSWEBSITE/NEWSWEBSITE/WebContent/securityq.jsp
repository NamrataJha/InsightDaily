...
<%
	try{
		String username="",q1,a1;
		if(request.getParameter("btnlog")!=null)
		{
			username=request.getParameter("email1");
			...
			Class.forName("com.mysql.jdbc.Driver");
	    	 ...
	    	 ResultSet rs=stmt.executeQuery("select ques1,ans1 from register where username='"+username+"' ");
	    	 if(rs.next())
	    	 {
	    		 if(q1.equals(rs.getString(1)) && a1.equals(rs.getString(2))){
	    			 response.sendRedirect("ChangePassword.jsp?type=forgotpassword");
	    		 }
	    	 }
	    	 else
	    	 {
                    ...
                    <div class="login-content">
                        ...
                        <form action="#" method="post">
                            <div class="form-group">
                                <input type="text" class="form-control" name="email1" id="exampleInputEmail1" placeholder="User Name">
                            </div>
                        ...
                        <input type="text" name="Ans1" id="a1" style="color:white; font-size: 10pt" class="form-control" placeholder="Your answer" required />                            	
                            ...
                            <button type="submit" name="btnlog" class="btn vizew-btn w-100 mt-30">Verify</button>
