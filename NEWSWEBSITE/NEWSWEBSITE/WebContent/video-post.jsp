<%@ page language="java" contentType="text/html; charset=ISO-8859-1"
    ...
    <%
    String breaknews[][]= new String[7][8];
    int s=0;
    try
    {
    	 ...
    	 String query="SELECT News_ID,Headline,News_Type,Date,Time,video,image,content FROM news WHERE News_Id="+request.getParameter("value")+" ORDER BY Priority desc,Date desc,Time desc;";
            ...
            <div class="row">
                <div class="col-12">
                    <div class="single-video-area">
                        <iframe src=<%= breaknews[0][5] %> allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
            ...
            <div class="row justify-content-center">
                ...
                <div class="col-12 col-lg-8">
                    <div class="post-details-content d-flex">
                        <!-- Post Share Info -->
                        <div class="post-share-info" style="color:white">
                            <p>Bookmark</p>
                            <% String color="white"; %>
                            <a href="#" onclick="bookfunction() return false;" class="thumb-tack" ><i class="fa fa-thumb-tack" style="color:white"></i></a>
							...
							<%
								Class.forName("com.mysql.jdbc.Driver").newInstance();
					    	 	Connection conn=DriverManager.getConnection("jdbc:mysql://localhost:3306/insightdaily","root","myproject");
					    	 	Statement stmt=conn.createStatement();
								String query="insert into bookmarks values(1019,6)";
								int x=stmt.executeUpdate(query);
								if(x>0){%>
									<a href="#" onclick="bookfunction() return false;" class="thumb-tack" ><i class="fa fa-thumb-tack" style="color:blue"></i></a>
								<%}
								else {%>
									<a href="#" onclick="bookfunction() return false;" class="thumb-tack" ><i class="fa fa-thumb-tack" style="color:white"></i></a>
							<% }%>         
                        ...
                        <div class="blog-content">
                            ...
                            <div class="post-content mt-0">
                                <a href="#" class="post-cata cata-sm cata-danger"><%=breaknews[0][2]%></a>
                                <a href="single-post.html" class="post-title mb-2"><%= breaknews[0][1] %></a>
                            ...
                            <%
            					 ...
            					 String txtFilePath = breaknews[0][7];
