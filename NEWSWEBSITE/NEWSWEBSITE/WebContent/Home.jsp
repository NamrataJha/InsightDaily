                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-12 col-md-6">
                        <div class="top-meta-data d-flex align-items-center justify-content-end">
                            ...
                            <% String link="loginas.jsp";
                            if(session.getAttribute("login")!=null) 
                            {
                            	link="ProfileUser.jsp";
                            }%>
                            <!-- Login -->
                           <a href=<%= link%> class="login-btn"><i class="fa fa-user" aria-hidden="true">
                            ...
                            if(session.getAttribute("login")!=null)
                            {
                            		...
                            		%><table><tr></tr><tr></tr><tr><td><%=val%></td></tr></table>
                            ...
                            try
                            {
                            	if(session.getAttribute("login")!=null)
                            	{
                            		%><a href=<%= link %> class="login-btn"><i class="fa fa-logout" aria-hidden="true"></i></a>
                            		<%
                            	}
                            }
                            catch(Exception e)
...
<%
  String hist [][]=new String[5][5];
  String query6="select ID,Headlines,images from history order by Dates,Times desc ";
  Class.forName("com.mysql.jdbc.Driver").newInstance();
	 //Connection conn=DriverManager.getConnection("jdbc:mysql://localhost:3306/insightdaily","root","myproject");
	// Statement stmt=conn.createStatement();
  ...
  for(int i=0;i<1;i++)
  {
	  if(rs.next())
	  {
	  hist[i][0]=""+rs.getInt(1);
	  hist[i][1]=rs.getString(2);
	  hist[i][2]=rs.getString(3);
  ...
  %>
                       ...
                       <div class="section-heading style-2 mb-30">
                            ...
                            <a href="history.jsp?value=<%= hist[0][0] %>"><img src="<%=hist[0][2] %>" alt="">
                              <h6 class="post-title"><%= hist[0][1] %> </h6></a>
