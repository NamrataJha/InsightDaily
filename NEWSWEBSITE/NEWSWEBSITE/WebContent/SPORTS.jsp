...
<div class="body_wrapper">
  <div class="center">
    <div class="header_area">
      <div class="logo floatleft"><a href="#"><img src="images/logoNEW.png" alt="" /></a></div>
    ...
    <div class="slider_area">
      <div class="slider">
        <ul class="bxslider">
          <li><img src="images/ipl-2020-players-auction-what-to-expect.jpg"alt="" title="Slider caption text" /></li>
          <li><img src="images/captains.jpg" alt="" title="Slider caption text" /></li>
      ...
      <div class="main_content floatleft">
        <div class="left_coloum floatleft">
          <div class="single_left_coloum_wrapper">
            ...
            <div class="single_left_coloum floatleft"> <img src="images/863398-arvind-kejriwal-1-pti.jpg" alt="" />
              <h3>Arvind Kejriwal won the Delhi elections</h3>
              <p>Delhi Chief Minister Arvind Kejriwal led AAP has scored a hatrick in the Delhi assembly 
              election and is all set to form the government for the third consecutive term in the national 
              capital.</p>
              <a class="readmore" href="https://timesofindia.indiatimes.com/india/delhi-election-results-7-reasons-why-arvind-kejriwal-led-aap-won/articleshow/74080213.cms">read more</a> </div>
