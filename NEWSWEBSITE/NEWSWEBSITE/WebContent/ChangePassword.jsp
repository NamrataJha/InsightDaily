...
<%
	try{
		String email="",user="",oldpass="",newpass="",pass="";
		if(request.getParameter("btnlog")!=null)
		{
			...
			if(request.getParameter("type").equals("username")){
				user=request.getParameter("user");
				int x=stmt.executeUpdate("update register set username='"+user+"' where emailid='"+email+"'");
		    	 if(x>0)
		    	 {
		    		 response.sendRedirect("ChangePassword.jsp?status=usersuccess&type=username");
		    	 }
		    	 else
		    	 {
		    		 response.sendRedirect("ChangePassword.jsp?status=usernotsuccess&type=username");
		    	 }
			...
			else if(request.getParameter("type").equals("password"))
			{
				...
				int x=stmt.executeUpdate("update register set password='"+newpass+"' where emailid='"+email+"' and password='"+oldpass+"'");
		    	 if(x>0)
		    	 {
		    		 response.sendRedirect("ChangePassword.jsp?status=passsuccess&type=password");
		    	 }
		    	 else
		    	 {
		    		 response.sendRedirect("ChangePassword.jsp?status=passnotsuccess&type=password");
		    	 }
			}
			else if(request.getParameter("type").equals("forgotpassword"))
			{
				pass=request.getParameter("fp");
				int x=stmt.executeUpdate("update register set password='"+pass+"' where emailid='"+email+"'");
		    	 if(x>0)
		    	 {
		    		 response.sendRedirect("ChangePassword.jsp?status=passsuccess&type=forgotpassword");
		    	 }
		    	 else
		    	 {
		    		 response.sendRedirect("ChangePassword.jsp?status=passnotsuccess&type=forgotpassword");
		    	 }
			}
		}
...
<head>
    ...
    <!-- Title -->
    <title>INSIGHT DAILY- Login</title>
            ...
            <div class="row justify-content-center">
                <div class="col-12 col-md-6">
                    <div class="login-content">
                        ...
                        <% String title="Edit your profile"; 
                        ...
                        <form action="#" method="post">
                            ...
                            { %>
                            	<div class="form-group">
                                <input type="password" class="form-control" name="fp" id="exampleInputEmail1" placeholder="New Password">
                            </div>
                            ...
                            {%>
                            <div class="form-group">
                                <input type="password" class="form-control" name="op" id="exampleInputEmail1" placeholder="Old Password">
                            </div>
                            <div class="form-group">
                            ...
                            <button type="submit" name="btnlog" class="btn vizew-btn w-100 mt-30">Update</button>
                            <% String t="";
                            if(request.getParameter("status")!=null){
                            	if(request.getParameter("status").equals("usersuccess"))
                            		t="Username updated successfully";
                            	else if(request.getParameter("status").equals("usernotsuccess"))
                            		t="Username not updated successfully";
                            	else if(request.getParameter("status").equals("passsuccess"))
                            		t="Password updated successfully";
                            	else if(request.getParameter("status").equals("passnotsuccess"))
                            		t="Password not updated successfully";
                            }
