	...
	try{
		...
		if(request.getParameter("btnlog")!=null)
		{
			...
			Class.forName("com.mysql.jdbc.Driver");
	    	 ...
	    	 if(request.getParameter("value").equals("Reader"))
	    			 {
	    		 table="register";
	    			 }
	    	 else if(request.getParameter("value").equals("Journalist"))
	    	 {
	    		 table="journalist";
	    	 }
	    	 else
	    	 ...
	    	 ResultSet rs=stmt.executeQuery("select emailid,password from "+table+" where emailid='"+email+"' and password='"+pass+"' ");
	    	 if(rs.next())
	    	 {
                    ...
                    <div class="login-content">
                        ...
                        <form action="#" method="post">
                            <div class="form-group">
                                <input type="email" class="form-control" name="email1" id="exampleInputEmail1" placeholder="Email or User Name">
                            </div>
                            <div class="form-group">
                            ...
                            <button type="submit" name="btnlog" class="btn vizew-btn w-100 mt-30">Login</button>
                            <% String a="";
                               if(request.getParameter("value").equals("Reader"))
                               {
                            	   a="New User? Register";
                          ...
                          <tr>
                          <td>
                          		 <a href="register.jsp" style="color:#e61907; text-align:left;"><%= a %></a>
                          </td>
                          <td>&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;</td>
                          <td>&nbsp; &nbsp; &nbsp; &nbsp; &nbsp;</td>
                          <td>&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; </td>
                          ...
                          <td>&nbsp; &nbsp;  &nbsp; &nbsp; &nbsp; &nbsp;</td>
                          <td>
                          		 <a href="ForgotPassword.jsp" style="color:#e61907; text-align:right;">Forgot Password?</a>
                          </td>
                          </tr>
                          </table>  
